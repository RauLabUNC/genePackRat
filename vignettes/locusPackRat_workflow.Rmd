...
Gene mode is designed for analyzing gene lists from RNA-seq or other gene-centric studies.
...
makeGeneSheet(
  ...
  split_criteria = list(
    ...
    "mouseMine_Immune" = "grepl('immune',OntologyAnnotation.ontologyTerm.name)"
  ),
...
```{r add_mouseMine_and_Open_Targets_data_region}
